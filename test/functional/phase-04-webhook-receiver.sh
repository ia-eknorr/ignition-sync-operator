...
req_ref=$(kubectl_json "ignitionsync/test-sync" '{.metadata.annotations.ignition-sync\.io/requested-ref}')
assert_eq "v2.0.0" "$req_ref" "requested-ref annotation set to v2.0.0"

req_by=$(kubectl_json "ignitionsync/test-sync" '{.metadata.annotations.ignition-sync\.io/requested-by}')
assert_eq "generic" "$req_by" "requested-by annotation is generic"

req_at=$(kubectl_json "ignitionsync/test-sync" '{.metadata.annotations.ignition-sync\.io/requested-at}')
